...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText username = findViewById(R.id.IDinput);//取得输入框的对象
        final EditText password = findViewById(R.id.code_input);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    connect.getConnection("whoere");//执行连接测试
        ...
        Register.setOnClickListener(new View.OnClickListener() {//注册
            ...
            public void onClick(View v) {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            connect.register(username.getText().toString(),password.getText().toString());//调用插入数据库语句
                        } catch (SQLException e) {
                            e.printStackTrace();
                        }
                    }
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            password_receive=connect.search_pw(username.getText().toString());//调用查询语句，获得账号对应的密码
                        } catch (SQLException e) {
                            e.printStackTrace();
